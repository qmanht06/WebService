            ...
            <div className={cx("grid", "body")}>
                <form>
                    <div>
                        ...
                        <div>
                            <button style={{ padding: '12px 30px', borderRadius: '6px', color: '#fff', backgroundColor: '#dc6540', margin: '0 auto', fontSize: '18px', fontWeight: '600', display: 'block' }} onClick={submitHandler}>Đặt hàng</button>
                        </div>
                    ...
                    <div style={{ marginTop: '60px' }}>
                        ...
                        <div>
                            {
                                cartList.map(item => (<CartItem key={item._id} product={item} editable={false} />))
                            }
                        </div>
                    </div>
