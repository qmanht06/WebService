        ...
        <>
            ...
            <div className={cx('grid', 'body')}>
                ...
                <div className={cx('body__item')}>
                    ...
                    <input className={cx('body__item__input')} type="text" placeholder='Tên sản phẩm' />
                </div>
                <div className={cx('body__item')}>
                    <p className={cx('body__item__title')}>Hình ảnh: </p>
                    <input className={cx('body__item__input')} type="file" placeholder='Hình ảnh' />
                </div>
                <div className={cx('body__item')}>
                    <p className={cx('body__item__title')}>Mô tả: </p>
                    <textarea className={cx('body__item__text-area')} id="" cols="100" rows="10" placeholder='Mô tả sản phẩm'></textarea>
                </div>
                <div className={cx('body__item')}>
                    <p className={cx('body__item__title')}>Giá tiền: </p>
                    <input className={cx('body__item__input')} type="text" placeholder='Giá tiền' />
